            ...
            <main className="pt-[8vh] bg-[#fffaf3] flex flex-col items-center gap-10 px-[8vw] text-center">
                <section className="story-section flex flex-col items-center gap-[6vh]">
                    <div className="story-content max-w-[840px] text-[20px]">
                        <h1 className="about-title text-[#e76f51] text-[50px] mb-6">
                            Our Story
                        </h1>

                        <p className="about-text text-gray-700 mb-4">
                        ...
                        <p className="about-text text-gray-700">
                    ...
                    <div className="story-image flex justify-center">
                        <img
                            src="/logo.png"
                            alt="logo"
                            className="about-image rounded-[15px] shadow-[0px_8px_20px_rgba(0,0,0,0.2)] hover:scale-105 transition-transform duration-500 block w-[70%] max-w-[700px] mb-[10vh]"
                        />
                    </div>
                </section>
            </main>
